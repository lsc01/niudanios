...
+ (instancetype)showStringPickerWithTitle:(NSString *)title
    ...
    return [[BRStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
