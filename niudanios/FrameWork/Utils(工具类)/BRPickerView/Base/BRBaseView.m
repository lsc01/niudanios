...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = RGB_HEX(0xF6F6F6, 1.0f);
    }
    return _topView;
}
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.titleLabel.font = [UIFont boldSystemFontOfSize:15.0f];
        [_leftBtn setTitleColor:RGB_HEX(0x1dcb7c, 1.0) forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.titleLabel.font = [UIFont boldSystemFontOfSize:15.0f];
        [_rightBtn setTitleColor:RGB_HEX(0x1dcb7c, 1.0) forState:UIControlStateNormal];
